...
export class NoteManager {
	...
	public async setStat(stat: string, value: string): Promise<boolean> {
		return this._setCategorizedNote(CategoryStats, stat, value) ? this.save() : false;
	}
	...
	public async unsetStat(stat: string): Promise<boolean> {
		return this._setCategorizedNote(CategoryStats, stat, undefined) ? this.save() : false;
	}
	public unsetStats(...stats: string[]): Promise<boolean> {
		let save = false;
		stats.forEach(stat => save = this._setCategorizedNote(CategoryStats, stat, undefined) || save);
	...
	// private unsetCategorizedNote(category: string, title: string): Promise<boolean> {
