...
import { DialogPostType, DiceOutputType, DicePostType, DiceSortType } from "@rsc-sage/types";
...
import { DiceSecretMethodType, getCriticalMethodText } from "@rsc-utils/game-utils";
