...
export async function sendDiceToMultiple(sageCommand: SageCommand, formattedOutputs: FormattedDiceOutput[], targetChannel: SupportedMessagesChannel, gmTargetChannel: Optional<MessageTarget>): Promise<void> {
