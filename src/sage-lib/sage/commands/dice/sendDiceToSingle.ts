...
export async function sendDiceToSingle(sageCommand: SageCommand, formattedOutputs: FormattedDiceOutput[], targetChannel: SupportedMessagesChannel, gmTargetChannel: Optional<SupportedTarget>): Promise<void> {
