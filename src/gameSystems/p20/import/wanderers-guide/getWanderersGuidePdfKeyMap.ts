...
export function getWanderersGuidePdfKeyMap(): PdfKeyMap {
	return new Map([
		// PDF Page 1
		...
		["spell_attack_prof_trained", { sageKey: "spellAttackTrained", checked: true }],
		["spell_attack_prof_expert", { sageKey: "spellAttackExpert", checked: true }],
		["spell_attack_prof_master", { sageKey: "spellAttackMaster", checked: true }],
		["spell_attack_prof_legendary", { sageKey: "spellAttackLegendary", checked: true }],
		...
		["deity_philosophy", { sageKey: "philosophy" }],
		...
		["spells_per_day_rank_1", { sageKey: "spellsPerDay1" }],
		["spells_per_day_rank_2", { sageKey: "spellsPerDay2" }],
		["spells_per_day_rank_3", { sageKey: "spellsPerDay3" }],
		["spells_per_day_rank_4", { sageKey: "spellsPerDay4" }],
		["spells_per_day_rank_5", { sageKey: "spellsPerDay5" }],
		["spells_per_day_rank_6", { sageKey: "spellsPerDay6" }],
		["spells_per_day_rank_7", { sageKey: "spellsPerDay7" }],
		["spells_per_day_rank_8", { sageKey: "spellsPerDay8" }],
		["spells_per_day_rank_9", { sageKey: "spellsPerDay9" }],
		["spells_per_day_rank_10", { sageKey: "spellsPerDay10" }]

		// TODO: These mappings need to be configured, but there don't appear to be direct
		// analogues in the Demimplane PDF - it doesn't break feats or abilities into categories.
