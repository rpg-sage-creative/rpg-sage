...
export class Coins extends HasCore<CoinsCore> implements IComparable<Coins> {
	/**************************************************************************************************************************/
	// Constructors
	...
	public compareTo(other: Coins): -1 | 0 | 1 {
	...
	public static compare(a: TMoney, b: TMoney): -1 | 0 | 1 {
