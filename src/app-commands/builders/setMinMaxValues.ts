import type { SlashCommandNumberOption } from "@discordjs/builders";
import { isValidNumber } from "@rsc-utils/number-utils";
import type { SlashCommandOption } from "../types.js";

export function setMinMaxValues<T extends SlashCommandNumberOption>(opt: T, option: SlashCommandOption): T {
