...
export class Collection<T> extends Array<T> {
	...
	public pluck<U extends keyof T = keyof T, V extends ValueOf<T, U> = ValueOf<T, U>>(key: U, onlyUnique: true): V[];
