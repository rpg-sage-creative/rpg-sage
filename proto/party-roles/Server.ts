...
export interface IPartyRole { did: Discord.Snowflake; owner: Discord.Snowflake; name:string; members:Discord.Snowflake[]; notes:{[did:string]:string;}; approved:boolean; }
...
export default class Server extends HasDidCore<ServerCore> implements IHasColorsCore, IHasEmojiCore {
	...
	public get partyRoles(): IPartyRole[] { return this.core.partyRoles ?? []; }
