...
export function parseHex(value: string, includeAlpha: true): string | null;

/** Parses the value to get a Hex value with NO alpha: #002244FF */
export function parseHex(value: string, includeAlpha: false): string | null;

export function parseHex(value: string, includeAlpha?: boolean): string | null {
