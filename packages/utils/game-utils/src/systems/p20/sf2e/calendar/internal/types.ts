...
export const MonthTypes = [MonthType.Abadius, MonthType.Calistril, MonthType.Pharast, MonthType.Gozran, MonthType.Desnus, MonthType.Sarenith, MonthType.Erastus, MonthType.Arodus, MonthType.Rova, MonthType.Lamashan, MonthType.Neth, MonthType.Kuthona] as const;
...
export const DayTypes = [DayType.Firstday, DayType.Seconday, DayType.Thirday, DayType.Fourthday, DayType.Fifthday, DayType.Sixthday, DayType.Seventhday] as const;
export const Days = ["Firstday", "Seconday", "Thirday", "Fourthday", "Fifthday", "Sixthday", "Seventhday"] as const;
export const DaysPerMonth = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31] as const;
