import type { GameOptions, GameUserData, SageChannel } from "@rsc-sage/data";
...
async function gameUpdate(sageCommand: SageCommand): Promise<boolean | undefined | null> {
	...
	const update = sageCommand.showConfirmationPrompts ? true : await discordPromptYesNo(sageCommand, `Update Game?`, true);
